<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Register eLearning</h1>
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.linkedin.com/in/restu-gede-purnama-aa9583277/">Restu Gede Purnama</a></p>
        </div>
